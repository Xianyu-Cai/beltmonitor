...
const We = (e, t) => (t + e) % 7, Je = j(
    (e) => {
        ...
        return /* @__PURE__ */ I("host", {
            shadowDom: !0, focus: r, children: [
        /* @__PURE__ */ p("div", { id: "h", part: "heading", children: s.formatter.format(w(s.yearMonth)) }),
        /* @__PURE__ */ I("table", {
                ref: n, "aria-labelledby": "h", part: "table", children: [
          /* @__PURE__ */ p("thead", {
                    children: /* @__PURE__ */ p("tr", {
                        part: "tr head", children: s.daysLong.map((o, a) => /* @__PURE__ */ I(
                            "th",
                            {
          ...
          /* @__PURE__ */ p("tbody", {
                    children: s.weeks.map((o, a) => /* @__PURE__ */ p("tr", {
                        part: "tr week", children: o.map((u, i) => {
...
function dt(e) {
    ...
    return /* @__PURE__ */ I("div", {
        role: "group", "aria-labelledby": "h", part: "container", children: [
...
const Qe = j(
    (e) => {
        ...
        return /* @__PURE__ */ p("host", {
            shadowDom: !0, focus: o.focus, children: /* @__PURE__ */ p(
                dt,
                {
                    ...e,
                    ...o,
